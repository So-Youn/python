...
def pmi(params):
    url = f'https://8oi9s0nnth.apigw.ntruss.com/corona19-masks/v1/storesByAddr/json?adress={params}'
    ...
    for data in response['stores'][:10]:
        ...
        #mask_info[data['name']] = data['remain_stat']    
    ...
    return mask_info
    #return response['stores'][:3]
params = input('주소를 시 구 동으로 입력해주세요 : ')
mask = pmi(params)
#print(mask)
#pprint.pprint(mask)   --  import pprint
#pprint(mask)
